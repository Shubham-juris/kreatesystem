  ...
  return (
    <Container maxWidth="md" sx={{ textAlign: "center", py: 5 }}>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ maxWidth: "80%", mx: "auto" }}>
        At Kreate Solution Systems, we understand the pivotal role e-commerce plays in modern businesses' success.
        We believe that a well-crafted online presence can significantly impact a company’s growth and profitability.
      </Typography>
    </Container>
  );
};
