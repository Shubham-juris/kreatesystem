      ...
      <Box sx={{ 
        ...
        <Box sx={{ flex: 1, maxWidth: { md: "55%" } }}>
          ...
          <Typography sx={{ mb: 3, fontSize: "1rem", lineHeight: 1.6 }}>
            ...
            • <strong>Salary:</strong> $24.10 hourly / 40 hours per week <br />
          ...
          <Typography sx={{ mb: 3, fontSize: "1rem", lineHeight: 1.6 }}>
            ...
            • Receive and register documents for data entry <br />
            • Verify accuracy and completeness of data <br />
            • Create digital records using a scanner <br />
            • Plan, organize, direct, and evaluate daily operations <br />
