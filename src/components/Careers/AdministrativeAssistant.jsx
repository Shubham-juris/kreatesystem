    ...
    <JobContainer component="main" maxWidth="lg">
      ...
      >
        ...
        <Box sx={{ flex: 1, maxWidth: { md: "55%" } }}>
          <SectionTitle variant="h5">Administrative Assistant</SectionTitle>
          ...
          <Typography sx={{ mb: 3, fontSize: "1rem", lineHeight: 1.6 }}>
            ...
            • <strong>Vacancies:</strong> 2 vacancies
          </Typography>
          ...
          <Typography sx={{ mb: 3, fontSize: "1rem", lineHeight: 1.6 }}>
            ...
            • Arrange and co-ordinate seminars, conferences, etc. <br />
            • Plan and control budget and expenditures <br />
            • Supervise other workers <br />
            • Establish and implement policies and procedures <br />
            • Train other workers <br />
            • Train, direct and motivate staff <br />
            • Record and prepare minutes of meetings, seminars and conferences <br />
            • Determine and establish office procedures and routines <br />
            • Plan, develop and implement recruitment strategies <br />
            • Schedule and confirm appointments <br />
            • Manage training and development strategies <br />
            • Answer electronic enquiries <br />
            • Order office supplies and maintain inventory <br />
            • Organize staff consultation and grievance procedures <br />
            • Oversee, direct, control and evaluate daily operations <br />
